...
Godot 版以固定 SDLPal 的经典回合制路径为行为基准，不启用 `ENABLE_REVISIED_BATTLE` 蓄力模式。静态资源、普攻回合、首批玩家/敌人攻击仙术、主经验成长和 `ScriptVM 004A/0007` 剧情桥接已经接通；物品、毒与状态仍在开发。
...
- 敌人状态/脚本仙术、召唤、合击、使用/投掷物品、逃跑和自动战斗；
