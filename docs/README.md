...
9. [经典战斗系统](BATTLE.md)：理解敌人、敌队、战场、Sprite、站位和当前实现边界。
10. [开发工作流](DEVELOPMENT_WORKFLOW.md)：运行、导入、测试、剧情检查点、提交和排错。
11. [SDLPal 上游基准](UPSTREAM.md)：查看固定参考提交和 Godot 模块到 SDLPal 源文件的映射。
