...
6. [经典菜单与物品页](CLASSIC_UI.md)：理解原版菜单布局、点阵字和物品资源。
7. [开发工作流](DEVELOPMENT_WORKFLOW.md)：运行、导入、测试、剧情检查点、提交和排错。
8. [SDLPal 上游基准](UPSTREAM.md)：查看固定参考提交和 Godot 模块到 SDLPal 源文件的映射。
