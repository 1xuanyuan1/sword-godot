...
合成测试验证固定随机序列、行动排序、双动、防御、最低伤害、死亡目标重选、胜负、主经验升级和 `004A/0007` 三种结果分支；本地 headless 测试验证真实敌队/Sprite、首战普攻、52 经验/96 文奖励及脚本 6964/6965 的阻塞请求；最后一个测试必须使用真实渲染器，把敌队 18 / 战场 21 的战斗、仙术、奖励和升级页截图写入被忽略的 `generated/pal/visual_tests/`。
