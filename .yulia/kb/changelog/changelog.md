...
### [FT-065] [feat] 完成扬州女飞贼主线

- **关联需求**: M5 完整流程
- **关联 TODO**: TD-008（阶段性）
- **功能描述**: 从扬州前山道继续完成城门盘查、客栈投宿与夜间失窃、两段屋顶追逐、布包 271 归还、姬三娘宅调查、井底取得紫金葫芦、首次受审、探监、黑衣女贼决战、复审和领取悬赏。覆盖林月如多次离队／归队、敌队 29 的夜间／屋顶双战、敌队 30 的真凶战、300 文探监费、5500 文悬赏及北门放行，最终以李逍遥／林月如 `[0,2]` 队伍和土灵珠 267 抵达场景 104“山路·蛤蟆谷前”；第九章更新为完整真实资源回归通过。
- **验证情况**: 新增独立主线测试，连续覆盖场景 82/78/81/92/96/84/97/85/83/88/89/91/80/87/90/104，断言消息 `5088–5193`、`5272–5320`、`5378–5538`、`5414–5680`、`5868–5922` 的剧情区段、敌队对象 `[478]`／`[526,479,526]`、真实胜利奖励、布包使用、金钱和最终场景状态。新增扬州城门、夜间客栈、屋顶、姬三娘宅、井底、府衙及蛤蟆谷前七个正式 TileMap 视口；同时把 Godot 默认清屏色改为原版黑色，修复地图透明孔洞露出灰底，37 个用例连续三轮达到 320×200 零像素差并实际检查人物、建筑、屋面、室内陈设、密道和府衙遮挡。
- **涉及文件**:
  - `project.godot`
  - `tests/run_local_yangzhou_mainline_test.gd`
  - `tests/run_local_tilemap_visual_test.gd`
  - `README.md`
  - `docs/GAME_WALKTHROUGH.md`
  - `docs/SCRIPT_VM.md`
