...
func _test_battle_content_structures() -> void:
	...
	_expect(magic != null and magic.magic_number == 33 and magic.effect_sprite == 12 and magic.magic_type == 3 and magic.speed == -2, "magic effect identity, type and signed speed")
