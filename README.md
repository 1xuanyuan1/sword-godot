...
真实资源回归已从御剑教学继续覆盖水月宫惨案、安葬返航、客栈强制战、离开余杭和抵达苏州。林月如城外两轮折返、敌队 21/22、刺伤救治之后，还会进入苏州客栈替刘晋元解围，完成敌队 23／战场 21、宴请过夜、日夜切换、赵灵儿暂时离队及次日叫醒归队；相关 EventObject、队伍、落点与音乐均有断言。首次求药赴岛使用独立的干净内容数据库验证，避免后期场景入口改写掩盖首次抵达对白。
