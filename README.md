...
真实资源回归已按连续章节边界覆盖从御剑教学、水月宫惨案、离开余杭、苏州、林家堡夜间、隐龙窟、白河村药材任务、第七章、鬼阴山、扬州、蛤蟆山、长安尚书府、蜀山锁妖塔、圣姑住处、神木林、隐密树洞、大理族议、火麒麟、回魂仙梦、灵儿生产、试炼窟、五灵珠祭坛、祭雨和地魔兽，一直推进到无底深渊、南诏王宫、假巫王双战、拜月教主／水魔兽终战及结局统一退出。最终章固定敌队 289／222／313、战场 57／55、完整消息 `434–584`、11 段 RNG 和 16 个结局播放器动作；新增 11 个正式 TileMap 视口后共登记 149 个像素用例，新增用例均逐个通过 Godot 4.7 Metal 真窗口 320×200 零差异检查并实际验图。当前主线脚本和音画请求链已可验证到最终 `00A0`，RNG 全部 12 段／1464 帧也已通过运行时流式解码；剩余工作集中在桌面导出、正式 CPU 地图路径退役及可选增强。
