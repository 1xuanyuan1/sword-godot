...
真实资源回归已从御剑教学继续覆盖水月宫惨案、离开余杭、苏州、林家堡夜间、隐龙窟、白河村药材任务、第七章、鬼阴山、扬州、蛤蟆山、长安尚书府及蜀山锁妖塔全程。第十二章连续断言姜清敌队 163／战场 35、天鬼皇敌队 293／战场 35、镇狱明王敌队 188／战场 31、七柱敌队 305–311／战场 31、酒神咒等三项仙术、雷灵珠与补给、七星剑、天书、三人队重组、七柱一次性状态、塔毁过场和最终单人队落点。蜀山、锁妖塔各层、塔底、崩塌及回忆也已加入正式 TileMap 视口；离屏截图会等待 Metal 完成本帧提交，83 个用例均通过真实窗口像素检查。
