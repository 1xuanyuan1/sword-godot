...
真实资源回归已从御剑教学继续覆盖水月宫惨案、安葬返航、离开余杭、苏州、林家堡夜间和隐龙窟：敌队 25 主动离场后可继续墙破西厢房剧情，半人蛇敌队 45 与狐狸精敌队 44 均使用真实战场结算，石钥匙 `289` 能打开一次性石门，获救少女离洞后队伍最终抵达白河村。相关消息、EventObject、队伍、落点、音乐和胜利奖励均有断言；半人蛇区、内洞、白河村前山路及村内四个正式 TileMap 视口也通过真实窗口像素检查。
