...
真实资源回归已从御剑教学继续覆盖水月宫惨案、离开余杭、苏州、林家堡夜间、隐龙窟、白河村药材任务、第七章、鬼阴山、扬州、蛤蟆山、长安尚书府、蜀山锁妖塔、圣姑住处、神木林、隐密树洞、大理族议、火麒麟、回魂仙梦、灵儿生产、试炼窟、五灵珠祭坛、祭雨和地魔兽。第十七章固定圣灵珠 260 开启祭坛、五灵珠 `263–267` 放置／归还、战时大理两场黑苗遭遇及地魔兽敌队 287／战场 36／对象 466；新增战场、神殿、祭坛、雨后大理和无底深渊 12 个正式 TileMap 视口后，共登记 138 个像素用例，新增用例均逐个通过 Godot 4.7 Metal 真实窗口 320×200 零差异检查并实际验图。当前稳定终点为场景 290“无底深渊”，灵儿／逍遥／阿奴 `[1,0,4]` 三人队、坐标 `(240,1672)` 及进入脚本 `3798`，下一段从无底深渊前往南诏王宫。
