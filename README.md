...
真实资源回归已从御剑教学继续覆盖水月宫惨案、离开余杭、苏州、林家堡夜间、隐龙窟、白河村药材任务、第七章全程和鬼阴山：守卫战、石长老剧情战、玉佛珠移除、灵儿离队、月如归队及扬州前山道均有连续状态断言。鬼阴山前路、迷宫、绝顶、鬼阴坛与扬州前山道也已加入正式 TileMap 视口；每个地图使用独立 SubViewport，避免 Metal 后端跨地图读回整屏旧帧，30 个用例均通过真实窗口像素检查。
