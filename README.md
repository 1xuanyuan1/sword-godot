...
在上述御剑教学边界之后，真实资源回归还会继续执行天亮返店、李大娘早餐对话和客房赵灵儿营救：赵灵儿临时入队后请求敌队 18／战场 21，胜利时运行 `0078` 官方空操作与 `0022` 复活清理，再正式入队并安装下一段事件入口。

营救战后的李大娘借船对话、张四再次送行、码头登船和双人抵达仙灵岛也已接入同一门禁；首次求药赴岛使用独立的干净内容数据库继续回归，避免后期场景入口改写掩盖首次抵达对白。
