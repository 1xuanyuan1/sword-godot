...
真实资源回归已从御剑教学继续覆盖水月宫惨案、安葬返航、离开余杭、林月如城外和苏州客栈次日，并进一步完成比武招亲、林家堡夜间及隐龙窟入口：敌队 25 会通过 `0069` 主动离场并继续剧情，墙破西厢房长剧情结束后抵达隐龙窟山道，月如/逍遥双人队伍最终进入“隐龙窟·近迹”。相关消息、EventObject、队伍、落点、音乐淡出/切换与渐隐均有断言；地图 39 的正式 TileMap 画面也通过真实窗口像素检查。
