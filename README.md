...
真实资源回归已从御剑教学继续覆盖水月宫惨案、安葬返航、离开余杭、林月如城外和苏州客栈次日，并进一步完成比武招亲：`00A3` 回退播放 RIX 14，`007F` 在不改变队伍世界位置的前提下逐帧移动 TileMap/CPU 镜头，敌队 24／战场 26 胜利后复位镜头、暂时移除赵灵儿并进入林家堡内厅。相关消息、EventObject、队伍、落点与音乐均有断言。
