...
真实资源回归已从御剑教学继续覆盖水月宫惨案、离开余杭、苏州、林家堡夜间、隐龙窟、白河村药材任务、第七章、鬼阴山、扬州、蛤蟆山及长安尚书府全程。第十一章连续断言敌队 38/39/42、战场 7/28/27、三万文援助、一万五千文道士费用、四件法事用品、彩依牺牲、三段回忆、RNG #3 御剑过场及蜀山落点。尚书府、刘晋元病房、酒剑仙法坛、毒仙林、毒娘子巢穴、三段回忆和蜀山也已加入正式 TileMap 视口；离屏截图会等待 Metal 完成本帧提交，58 个用例均通过真实窗口像素检查。
