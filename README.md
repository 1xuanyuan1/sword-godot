...
真实资源回归已从御剑教学继续覆盖水月宫惨案、离开余杭、苏州、林家堡夜间、隐龙窟和白河村药材任务：敌队 25 主动离场、半人蛇／狐狸精 Boss、石钥匙开门、韩医仙初诊、银杏果／鲤鱼／鹿茸、钓竿和捕兽夹场外脚本、六神丹及三人归队均有连续状态断言。新增鹿区、韩医仙屋外与恢复后诊厅三个正式 TileMap 视口；视觉测试改为每个地图使用独立 SubViewport，避免 Metal 后端跨地图读回整屏旧帧，14 个用例均通过真实窗口像素检查。
