...
真实资源回归已从御剑教学继续覆盖水月宫惨案、离开余杭、苏州、林家堡夜间、隐龙窟、白河村药材任务、第七章、鬼阴山及扬州全程：两次敌队 29、敌队 30 真凶战、布包 271、井底取证、林月如离队／归队、探监、复审、悬赏和北门放行均有连续状态断言。扬州城门、夜间客栈、屋顶、姬三娘宅、井底、府衙和蛤蟆谷前也已加入正式 TileMap 视口；每个地图使用独立 SubViewport，避免 Metal 后端跨地图读回整屏旧帧，37 个用例均通过真实窗口像素检查。
