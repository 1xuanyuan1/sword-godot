...
真实资源回归已从御剑教学继续覆盖水月宫惨案、离开余杭、苏州、林家堡夜间、隐龙窟、白河村药材任务和玉佛寺：敌队 25 主动离场、隐龙窟双 Boss、六味药材、六神丹、玉佛寺敌队 28／35、玉佛珠及清空版寺院均有连续状态断言。白河村后山、玉佛寺庭院／大殿／清空版也已加入正式 TileMap 视口；每个地图使用独立 SubViewport，避免 Metal 后端跨地图读回整屏旧帧，18 个用例均通过真实窗口像素检查。
