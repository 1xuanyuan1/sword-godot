...
真实资源回归已从御剑教学继续覆盖水月宫惨案、离开余杭、苏州、林家堡夜间、隐龙窟、白河村药材任务、第七章、鬼阴山、扬州及蛤蟆山全程。第十章连续断言敌队 36／战场 18、剧情敌队 37／战场 20、五毒珠 262、白苗酒店队伍切换、船家入口改写及长安落点。蛤蟆谷、洞穴、白苗酒店、长安城外、水仙尊王庙和长安也已加入正式 TileMap 视口；每个地图使用独立 SubViewport，避免 Metal 后端跨地图读回整屏旧帧，47 个用例均通过真实窗口像素检查。
