...
func _show_report(report: PalImportReport) -> void:
	...
	for file_name: String in report.files.keys():
		if file_name in ["fbp_preview", "sprite_preview", "map_preview", "rng_preview", "voc_conversion", "rix_conversion", "mgo_conversion", "rgm_conversion", "content_database", "text_conversion", "enemy_battle_sprites", "player_battle_sprites", "battle_backgrounds"]:
			continue
